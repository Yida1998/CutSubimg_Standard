...
if __name__ == '__main__':
    # 训练集
    dict_train = {}
    root_path_train = '/Users/yida/Desktop/土壤_wwr/实验四1128/手机1一加/train/subimg_1'

    # 验证集
    dict_val = {}
    root_path_val = '/Users/yida/Desktop/土壤_wwr/实验四1128/手机1一加/val/subimg_1'
    ...
    for i in class_img:
        path_class = os.path.join(root_path_val, i)  # i个类别
        ...
        for j in file_class:
            ...
            m = len(file_sub)  # m张子图
            print("第{}的{}张土壤图像共有{}张土壤子图".format(i, j, m))
            dict_val['{}_{}'.format(i, j)] = m
    np.save('dict_val.npy', dict_val)
    dict_train = np.load('dict_val.npy', allow_pickle=True).item()  # 转换成字典
    print("测试集", dict_train)
    print(type(dict_train))
